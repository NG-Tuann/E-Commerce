    ...
    public class CustomerController : Controller
    {
        ...
        public IActionResult Register(string mail)
        {
            ...
            if (mail != null && mail.Length > 0)
            {
                ...
                {
                    var password = Admin.Helpers.PrimarykeyHelper.RandomString(6);

                    var mailHelper = new MailHelper(_configuration);
                    string to = mail;
                    string subject = "Đăng ký thành viên thành công tại PTJ";
                    string content = "<table style='margin-bottom:20px;' width='100%' border='0' cellspacing='0' cellpadding='0'> <tr> <td align='center' style='text-align: center;'> <img src='https://ijc.vn/vnt_upload/weblink/Logo_IJC__Slogan_1.png' width='220' height='100'> <h1 style='color:#DCB15B;font-size: 40px;margin: 0;'>Đăng ký thành công</h1> <h3>IJC cám ơn bạn đã tin tưởng chọn và chọn chúng tôi</h3> <p>Bạn đã đăng ký thành công, vui lòng thay đổi mật khẩu sau khi đăng nhập</p> <p style='font-weight: bolder;'>Mật khẩu của bạn là, vui lòng không chia sẽ mật khẩu này:</p> <span style='color:#DCB15B; border:1px solid #E5E5E5; font-size: 40px; padding: 10px;'>" + password + "</span> </td> </tr> </table>";
                    ...
                    if (mailHelper.Send(from, to, subject, content))
                    {
                        ...
                        customer.Id = "MB" + PrimarykeyHelper.RandomString(6);
